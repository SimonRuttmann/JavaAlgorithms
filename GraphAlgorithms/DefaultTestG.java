        ...
        for (String list : testsToDo.split(" ")) {
            ...
            switch (list) {
                ...
                case "Zusammenhangskomponenten":
                    ...
                    ArrayList2 = new int [] [] {
                            {0},            //Knoten 0 ist in ZK 0
                            {2},            //knoten 2 ist in ZK 1
                            {1,3,4},        //Knoten 1,3,4 ist in ZK 2
                            {5,6}           //Knoten 5,6 ist in ZK 3
                    };
                    ...
                    //Knoten:   ZSK:
                    // 0        4       --  0,3,4 in ZSK aber 1,3,4 sollte ZSK sien
                    // 1        2
                    // 2        0
                    // 3        4       --
                    // 4        4       --
                    // 5        1           -- muss in einer ZSK sein
                    // 6        3           --

                    //DEBUG
                    //for ( int i = 0; i < graph.size(); i++){
                    //    System.out.println("Knoten = " + i + "   Komponente = "   + (SCC.component(i) )   );
                    //}
                ...
                case "minPrim":
                 ...
                 /*   Wgraph = new WeightedGraphImpl((new int[][]{
                    ...
                    for (int i = 0; i < ArrayList.length; i++) {
                        //System.out.println("Vorgängerknoten von " + i +  " = " +  graphMSF.pred(i) );
                ...
                case "BellmanFordDijkstra":
                    ...
                    ArrayList = new int [] {};
                    assert (!SPgraph.bellmanFord(Wgraph, 0)) : "BellmenFord liefert true zurück liefer sollte aber false sein";
                    Wgraph = new WeightedGraphImpl((new int [][] {
                            {1},
                            {2,3},
                            {4},
                ...
                case "Bellman2":
                    ...
                    assert (SPgraph.bellmanFord(Wgraph, 0)) : "BellmenFord liefert false zurück"; // Negativer Zyklus
